return {
	bot_api_key = "338329359:AAGS8I1w3bM-I1x0CyRrvnEgW9teoHwzTXw", --Please add your bot api key here!
	cmd = '^[/!#]',
	allowed_updates = {"message", "edited_message", "callback_query"},
	db = 2, --default redis db: 0
	superadmins = {190146160},
	log = {
		chat = -1001096220962, --Your log chat, where your bot must be added!
		admin = 190146160, --The admin.
		stats = nil
	},
	...
	channel = '@linksaramarkazi', --channel username with the '@'
	link_sara = 'https://t.me/joinchat/AAAAAEIUwVSzByX9-rs32g',
	help_groups_link = 'telegram.me/linksaramarkazi',
	plugins = {
